        ...
        if os.getenv("TB_AUTOCOMMIT_ARTIFACTS", "1") == "1":
            ...
            code = subprocess.call([
                ...
                (
                    ...
                    "print(ac.auto_commit_and_push(['runs','eval_runs','universe_runs','bars','state','data','eval_data','trader_loop.log','trading_agent.log','validation_report_*.json','validation_analysis.db','integration_test_results_*.json','test_integration_report.json','*_integration_report.json'], "
                    "extra_message='local artifacts + validation data + integration tests + bar data + trader state + eval data', push_enabled="
