...
export TB_ASSET_LIST=${TB_ASSET_LIST:-"BTC/USD,ETH/USD,SOL/USD,LINK/USD,LTC/USD,BCH/USD,UNI/USD,AAVE/USD,AVAX/USD,DOT/USD,MKR/USD,COMP/USD,YFI/USD,CRV/USD,SNX/USD,SUSHI/USD,XTZ/USD,GRT/USD"}
